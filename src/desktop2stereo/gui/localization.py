...
MESSAGE_CATALOGS = {
    ...
    "Projection RCAS tooltip": "Applies RCAS after shared mip filtering and scaling. Recommended: 0.50.",
        ...
        "Headset optimized": "Headset optimized",
        ...
        "Width crop (Left / Right)": "Width crop (Left / Right)",
        "Height crop (Top / Bottom)": "Height crop (Top / Bottom)",
        "Flat": "Flat",
        "Subtle": "Subtle",
        "Medium": "Medium",
        "Deep": "Deep",
        ...
        "Reset": "Reset",
        "Run": "Run",
        "Switch to new menu": "New Menu",
        "Switch to legacy menu": "Legacy Menu",
        ...
        "Status CPU Readback": "CPU readback",
        "Status GPU Copies": "GPU copies",
        "Status Zero Readback": "Zero readback",
        "Status Resource": "Resource",
        "Status DirectML": "DirectML",
       ...
       "Preview":"Preview",
        ...
        "Window Preview": "Depth Map Window",
        "Theme:": "Theme:",
        ...
        "tooltip_xr_preview": "Show the desktop XR window while running OpenXR Link.",
        ...
        "tooltip_lsfg": "Show the Vulkan Local Viewer as a Windows taskbar button so Lossless Scaling (LSFG) can select and capture it.",
        ...
        "XR Render:": "XR Render:",
        "tooltip_openxr_render_resolution": "OpenXR projection resolution as a percentage of the runtime's recommended eye resolution. Auto uses the selected headset target; higher values are limited by the runtime.",
        ...
        "tooltip_theme_toggle_to_dark": "Switch to dark mode",
        "tooltip_theme_toggle_to_light": "Switch to light mode",
        ...
        "tooltip_stream_calibration_mode": "Transmission profile: Auto Calibration applies the saved end-to-end FPS and safe bitrate result; Manual ignores the saved calibration bitrate and uses the normal dynamic bitrate calculation.\n\nRecalibration is also recommended when:\n• Changing the router, Wi-Fi band, or headset connection location.\n• Switching to a different Pico, Quest, or other headset.\n• Completing a major browser or headset system update.\n• Changing the output resolution, encoding format, or image settings.\n• Changing the computer GPU, driver, or performance mode.",
    ...
    "Projection RCAS tooltip": "在统一 MIP 过滤和缩放后应用 RCAS 锐化。建议值：0.50。",
        ...
        "Dynamic Crop": "动态裁剪",
        "Reset Crop": "重置裁剪",
        "Width crop (Left / Right)": "宽度裁剪（左右）",
        "Height crop (Top / Bottom)": "高度裁剪（上下）",
        "Flat": "直面",
        "Subtle": "微曲",
        "Medium": "中曲",
        "Deep": "重曲",
        "Surround Glow": "环绕辉光",
        "Glow transparency": "辉光透明度",
        "Veil": "光幕",
        "OFF": "关闭",
        ...
        "Reset": "重置",
        "Run": "运行",
        "Switch to new menu": "新版菜单",
        "Switch to legacy menu": "旧版菜单",
        ...
        "Status Stereo": "合成",
        "Status Fallback": "回退",
        "Status CPU Readback": "CPU回读",
        "Status GPU Copies": "GPU复制",
        "Status Zero Readback": "零回读",
        "Status Resource": "资源",
        "Status DirectML": "DirectML",
        "Status Reason": "原因",
        "Status Yes": "是",
        ...
        "Stereo Output:": "立体输出:",
        "XR Preview Window": "XR窗口",
        "Window Preview": "深度图窗口",
        "Theme:": "主题颜色:",
        "torch.compile": "torch.compile",
        "TensorRT": "TensorRT",
        ...
        "tooltip_xr_preview": "运行 OpenXR Link 时显示桌面 XR 窗口。",
        ...
        "tooltip_lsfg": "将 Vulkan 本地查看窗口显示为 Windows 任务栏按钮，供 Lossless Scaling（LSFG）选择和捕获。",
        ...
        "XR Render:": "XR渲染：",
        "tooltip_openxr_render_resolution": "OpenXR 投影分辨率，相对于运行时推荐的单眼分辨率。自动模式使用所选头显目标；更高值仍受运行时上限限制。",
        ...
        "tooltip_lang": "界面语言",
        "tooltip_theme": "主题颜色",
        "tooltip_theme_toggle_to_dark": "切换到深色模式",
        "tooltip_theme_toggle_to_light": "切换到浅色模式",
